%% script compiles heatmap diagrams when varying n, a, b and A* with sigmoidal lambda.
...
for n = [1,2,3,4]
    ...
    %import data
	csvFileName = sprintf('%s\\sigmoid-n%.0f-number-stable.csv',dataFilesDirectory,n);
