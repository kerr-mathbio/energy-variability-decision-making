# code to calculate number of stable steady states of non-linear ODEs with sigmoidal lambda.
import os
...
csvFileName = "data-files/thetaA-high-number-stable.csv"
export_Dataframe = numStableSSDataframe.to_csv(
...
for thetaBStep in range(len(thetaBStepsHigh)):
    ...
    for step in range(len(energySteps)):
        ...
        numStableSSDataframe.loc[len(numStableSSDataframe)] = [a, b, k, n, thetaA, thetaB,
                                                               energy, len(uniqueSteadyStatesList), numStableMatches]
# export dataframe to csv files (without index col)
csvFileName = "data-files/thetaB-high-number-stable.csv"
export_Dataframe = numStableSSDataframe.to_csv(
    csvFileName, index=False, header=True)
# ------------------------------------------
# ------------------------------------------
...
numStableSSDataframe = pd.DataFrame(
    index=[], columns=['a', 'b', 'k', 'n', 'thetaA', 'thetaB', 'Energy',
                       'NumberSteadyStates', 'NumberStableSteadyStates'])
# loop through thetaA (0.01:0.01:0.1)
...
for thetaAStep in range(len(thetaAStepsLow)):
    ...
    for step in range(len(energySteps)):
        ...
        numStableSSDataframe.loc[len(numStableSSDataframe)] = [a, b, k, n, thetaA, thetaB,
                                                               energy, len(uniqueSteadyStatesList), numStableMatches]
# export dataframe to csv files (without index col)
csvFileName = "data-files/thetaA-low-number-stable.csv"
export_Dataframe = numStableSSDataframe.to_csv(
    csvFileName, index=False, header=True)
# -------------------------------------------------------
# -------------------------------------------------------
...
numStableSSDataframe = pd.DataFrame(
    index=[], columns=['a', 'b', 'k', 'n', 'thetaA', 'thetaB', 'Energy',
                       'NumberSteadyStates', 'NumberStableSteadyStates'])
# loop through thetaB (0.01:0.01:0.1)
...
for thetaBStep in range(len(thetaBStepsLow)):
    ...
    for step in range(len(energySteps)):
        ...
        numStableSSDataframe.loc[len(numStableSSDataframe)] = [a, b, k, n, thetaA, thetaB,
                                                               energy, len(uniqueSteadyStatesList), numStableMatches]
# export dataframe to csv files (without index col)
csvFileName = "data-files/thetaB-low-number-stable.csv"
export_Dataframe = numStableSSDataframe.to_csv(
    csvFileName, index=False, header=True)
